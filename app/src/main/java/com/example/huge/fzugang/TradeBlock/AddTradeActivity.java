...
public class AddTradeActivity extends BaseActivity{
    ...
    private void init(){
        ...
        //设置Gridview点击事件
        addPictureGrid.setOnItemClickListener((adapterView, view, position, id) -> XXPermissions.with(AddTradeActivity.this)
            ...
            .request(new OnPermission() {
                ...
                public void hasPermission(List<String> granted, boolean isAll) {
                    if (isAll){
                        ...
                        XXPermissions.gotoPermissionSettings(AddTradeActivity.this);
                    }
                }
                @Override
                public void noPermission(List<String> denied, boolean quick) {
                    Toast.makeText(AddTradeActivity.this,"没有权限无法添加图片,请在设置内授予权限..",Toast.LENGTH_SHORT).show();
                    XXPermissions.gotoPermissionSettings(AddTradeActivity.this);
                }
            }));
